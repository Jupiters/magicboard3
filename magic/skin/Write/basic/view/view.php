...
<!-- 글내용 -->
<div class="content">
  <?php if(sizeof($file->Action('images', $this->Config('img_width'), null, false))!=0) {?>
  <div class="center" style="margin-bottom:20px"><?php foreach ($file->Action('images', $this->Config('img_width'), null, false) as $vv) {?>
