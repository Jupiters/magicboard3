...
$link['form']['include'][$mode_name] = 'form';

$link['reply']['include'][$mode_name] = 'form';
$link['reply']['include']['wr_no'] = $att[1];
$link['reply']['include']['parent_no'] = $att[2];
