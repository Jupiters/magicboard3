  ...
  function ShowActiveMenu() {
    $("#menu div.submenu").each(function(){
      if(!$(this).hasClass("activelink")) {
        $(this).clearQueue().stop().height("0px");
      } else {
        //var width = 0;
