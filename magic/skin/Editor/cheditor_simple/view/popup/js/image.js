...
// ----------------------------------------------------------------------------------
	...
	// 호스트 수조가 이미지에 삽입되는것을 막기위함
	var fileUrl = tmpData.fileUrl;
	var pos = fileUrl.indexOf(location.host);
	tmpData.fileUrl = tmpData.fileUrl.substring(pos + location.host.length);
	// kevinpark1981@gmail.com
