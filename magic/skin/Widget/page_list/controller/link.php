...
$link['delete']['include'][$key_name] = $this->file_no;
...
$link['write']['include']['pos'] = $att[1];
$link['write']['include']['length'] = $att[2];
$link['write']['include']['table'] = $att[3];
$link['write']['include']['key'] = $att[4];
$link['write']['include']['field'] = $att[5];
